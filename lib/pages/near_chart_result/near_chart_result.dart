...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const EyeTestResultsScreen(),
...
class _EyeTestResultsScreenState extends State<EyeTestResultsScreen> {
  ...
  try {
    ...
    final response = await http.post(
      Uri.parse('http://localhost:5000/api/nearchart'),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            _buildEyeResult(
                              'ตาขวา',
                              eyeTestResults['right_eye']['right_va'],
                            ),
                            // Left eye on the right side
                            _buildEyeResult(
                              'ตาซ้าย',
                              eyeTestResults['left_eye']['left_va'],
                        ...
                        Text(
                          'ตาขวาผลการวัดค่าสายตาอยู่ บรรทัดที่ ${eyeTestResults['right_eye']['right_line']}',
                          style: const TextStyle(fontSize: 16, letterSpacing: -0.5, fontWeight: FontWeight.w600),
                        ),
                        Text(
                          'ตาซ้ายผลการวัดค่าสายตาอยู่ บรรทัดที่ ${eyeTestResults['left_eye']['left_line']}',
                          style: const TextStyle(fontSize: 16, letterSpacing: -0.5, fontWeight: FontWeight.w600),
                        ),
