...
class _NearChartOneState extends State<NearChartOne> {
  ...
  Future<void> _loadUserId() async {
    final id = await UserService.getCurrentUserId();
    setState(() {
      userId = id;
    });
  }
  ...
  Future<void> saveSelectedLine(String line, int index) async {
    ...
    // Also save the user ID for API calls
    await prefs.setString('near_chart_user_id', userId);
  }
        ...
        children: [
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                context.go('/tutorial-category'); // Go back to home
              },
              child: Container(
